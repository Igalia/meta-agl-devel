...
SRC_URI = "git://github.com/enactjs/enact.git;nobranch=1;destsuffix=git/enact"
...
do_compile() {
    ...
    for LIB in core ui moonstone spotlight i18n webos ; do
        ...
        ${ENACT_NODE} ${AGL_ENACTJS_TOOL_PATH}/node_binaries/enact-typedef.js
        cd ${S}
        ${ENACT_NPM} pack --loglevel=error ./enact/packages/${LIB}
    done

    ${ENACT_NPM} pack --loglevel=error ${AGL_ENACT_DEPENDENCIES}
