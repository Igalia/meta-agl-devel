...
DEPENDS = "virtual/gettext wayland wayland-native pixman freetype glib-2.0 fontconfig openssl pango cairo icu libxkbcommon libexif dbus pciutils udev libcap alsa-lib virtual/egl elfutils-native libdrm atk gperf-native gconf nss nss-native nspr nspr-native bison-native qemu-native gtk+3"

PROVIDES = "${BROWSER_APPLICATION}"

SRC_URI = "\
    git://github.com/igalia/${PN};branch=apuentes@agl;protocol=https;rev=${SRCREV_chromium72} \
    git://github.com/webosose/chromium-v8;branch=@chromium72;destsuffix=git/src/v8;rev=${SRCREV_v8} \
    file://v8-qemu-wrapper.patch \
"
SRCREV_chromium72 = "37754748ecb50a33ec6d69bcca9fcce8359c1b1f"
...
BROWSER_APPLICATION = "chromium72-browser"
BROWSER_APPLICATION_DIR = "/opt/chromium72"
...
#   PACKAGECONFIG_append_pn-chromium72 = " debug-webcore"
...
python do_create_v8_qemu_wrapper () {
    ...
    print("GENERATING THE QEMU WRAPPER AT {}".format(wrapper_path))
...
python do_write_toolchain_file () {
    ...
    print("GENERATING TOOLCHAIN AT {}".format(toolchain_file))
